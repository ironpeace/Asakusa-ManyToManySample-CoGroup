...
@SuppressWarnings("deprecation") public final class ShuffleKey implements SegmentedWritable {
    ...
    /**
     * MainOperator.m2mJoined#listAが利用するキー (id)
     */
    public IntOption groupElem0Term1 = new IntOption();
    /**
     * MainOperator.m2mJoined#listAのキーの元になるモデルオブジェクトを設定する
    ...
    /**
     * MainOperator.m2mJoined#listBのキーの元になるモデルオブジェクトを設定する
     * @param source 設定するモデルオブジェクト
     */
    public void setPort2(ModelAb source) {
        this.portId = 2;
        this.groupElem0Term1.copyFrom(source.getIdOption());
    }
    /**
