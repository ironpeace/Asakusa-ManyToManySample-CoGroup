...
@TraceLocation(batchId = "mmsBatch", flowId = "MainJobFlow", stageId = "stage0001") public final class StageClient 
    ...
    @Override protected List<StageInput> getStageInputs() {
        ...
        results.add(new StageInput("__DIRECTIO__/modelA/mms/input", BridgeInputFormat.class, StageMapper1.class, 
                attributes));
        attributes = new HashMap<String, String>();
        attributes.put("basePath", "/mms/input/");
        ...
        results.add(new StageInput("__DIRECTIO__/modelB/mms/input", BridgeInputFormat.class, StageMapper2.class, 
                attributes));
        return results;
    }
