...
import teppeistudio.operator.MainOperatorFactory.M2mJoined;
...
public class MainJobFlow extends FlowDescription {
	...
	protected void describe() {
		...
		//②Extendした両モデルを、CoGroup(グループ結合)
		M2mJoined joined = op.m2mJoined(extendedA.out, extendedB.out);
		
		this.modelAB.add(joined.listAB);
	}
